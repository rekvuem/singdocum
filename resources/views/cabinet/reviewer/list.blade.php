...
@section('title', 'Перечень документів рецезента')
@section('page_styles')
<style>
  ...
  <div class="col-md-12">
    <div class="card rounded-0">
      <div class="card-header bg-transparent header-elements-inline">
        <h6 class="card-title">Документи на підпис</h6>
      </div>
      ...
      <table class="table table-responsive-md table-responsive-sm tasks-list table-lg">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$typeOfDocum}}</td>
            <td>
              <a href="{{route('cabinet.sign.check', ['type'=>$view->type,'token'=>$view->token])}}" class="btn">дивитися</a>
            </td>
          </tr>
          @endforeach
        </tbody>
