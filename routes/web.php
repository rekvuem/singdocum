...
// создание документа 
  Route::get('/document_choose', [DocumentController::class, 'chooseDocument'])->name('cabinet.choose.document');
  Route::get('/document_select/{typeId}', [DocumentController::class, 'SelectDocument'])->name('cabinet.select.document');
